...
import { decrementProduct, incrementProduct, initializeProductsAsync, resetProducts } from "../../store/productsReducer"
...
const Home = () => {
    ...
    useEffect(() => {
        dispatch(initializeProductsAsync())
    }, [])

    if (error) {
        return (
            <StyledHome>
                <h2 style={{ color: 'palevioletred' }}>{error}</h2>
            </StyledHome>
        )
    }
